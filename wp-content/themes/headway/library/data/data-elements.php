...
class HeadwayElementsData {
	...
	public static function get_element_properties($element, $element_group = 'blocks') {
	...
	public static function get_special_element_properties($element, $se_type, $se_meta, $element_group = 'blocks') {
	...
	public static function get_special_element_property($element_id, $se_type, $se_meta, $property_id, $default = null, $element_group = 'blocks') {
		...
		$properties = self::get_special_element_properties($element_id, $se_type, $se_meta, $element_group);
