...
class HeadwayLayout {
	...
	public static function add_template($template_name = null, $blocks = null) {
		...
		$block_id_translations = array(); /* Will be used for when a blocks imported ID is different than the one that it ends up with... i.g. skin importing to line up instances */
		...
		return array('id' => $id, 'name' => $template_name, 'block-id-translations' => $block_id_translations);
