				...
				array(
					...
					'description' => '
						If you are a member of the Headway Affiliate program, you can paste your affiliate link and earn money when someone purchases Headway through your affiliate link.  <strong>Do NOT put HTML in this field.</strong>
							<br /><br /><strong>Trouble Finding Your Affiliate Link?</strong>  When you log into your affiliate account dashboard, Look for the box titled "Campaigns" and copy the campaign link you see there. It should be <code>http://zfer.us/<em>yourcode</em></code> where <em>"yourcode"</em> would be your actual affiliate code. Paste that into the affiliate link box here.
